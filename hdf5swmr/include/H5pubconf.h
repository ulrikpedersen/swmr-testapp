...
#define H5_PACKAGE_STRING "HDF5 1.10.0-alpha1"
...
#define H5_PACKAGE_VERSION "1.10.0-alpha1"

/* Determine the maximum decimal precision in C */
#define H5_PAC_C_MAX_REAL_PRECISION 18
...
#define H5_VERSION "1.10.0-alpha1"
